...
from zialab.instruments.pipython.gcsmessages import GCSMessages
from zialab.instruments.pipython.gcscommands import GCSCommands
from zialab.instruments.pipython.interfaces.gcsdll import GCSDll
...
class GCSDevice(GCSCommands):
    ...
    def __init__(self, devname='', gcsdll='', gateway=None):
        ...
        @type gateway : zialab.instruments.pipython.interfaces.pigateway.PIGateway
        """
